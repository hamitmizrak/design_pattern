...
public abstract  class MultipleDatabasePrototype implements Cloneable {
	...
	//url=jdbc:mysql://localhost:3306/design_pattern?
	private String url=this.dbAnother+":"+getDbName()+"://"+localhost+":"+portNumber+"/"+schema;
	...
	public String toString() {
		return "MultipleDatabasePrototype [username=" + username + ", password=" + password + ", dbAnother=" + dbAnother
				+ ", dbName=" + getDbName() + ", localhost=" + localhost + ", portNumber=" + portNumber + ", schema="
				+ schema + ", url=" + url + "]";
	}
